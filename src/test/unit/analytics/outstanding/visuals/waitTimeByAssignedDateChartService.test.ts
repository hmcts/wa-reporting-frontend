...
import { snapshotWaitTimeByAssignedDateRepository } from '../../../../../main/modules/analytics/shared/repositories';

jest.mock('../../../../../main/modules/analytics/shared/repositories', () => ({
  snapshotWaitTimeByAssignedDateRepository: { fetchWaitTimeByAssignedDateRows: jest.fn() },
}));
...
describe('waitTimeByAssignedDateChartService', () => {
  ...
  test('maps rows into wait time points', async () => {
    const filters = {};
    (snapshotWaitTimeByAssignedDateRepository.fetchWaitTimeByAssignedDateRows as jest.Mock).mockResolvedValue([
    ...
    expect(snapshotWaitTimeByAssignedDateRepository.fetchWaitTimeByAssignedDateRows).toHaveBeenCalledWith(
      snapshotId,
      filters
    );
  ...
  test('propagates repository errors', async () => {
    ...
    (snapshotWaitTimeByAssignedDateRepository.fetchWaitTimeByAssignedDateRows as jest.Mock).mockRejectedValue(error);
