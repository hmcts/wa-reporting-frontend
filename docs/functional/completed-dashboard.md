...
- The chart fits the y-axis to the highest visible value needed to show either the stacked task total or the rolling-average line, then rounds up to the next labelled tick above it, including when the visible date range is narrowed or reset.
- Table columns:
  - Completed date
  - Tasks
  - Within due date
...
- Displays:
  ...
  - The chart fits the y-axis to the highest visible line value and rounds up to the next labelled tick above it, including when the visible date range is narrowed or reset.
